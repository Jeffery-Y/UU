...
import com.example.lenovo.uu.view.HeaderLayout.HeaderStyle;
import com.example.lenovo.uu.view.HeaderLayout.onLeftImageButtonClickListener;
...
public abstract class FragmentBase extends Fragment {
	...
	public void initTopBarForLeftBtn(String titleName,int leftDrawableId, onLeftImageButtonClickListener listener) {
		mHeaderLayout = (HeaderLayout)findViewById(R.id.common_actionbar);
		mHeaderLayout.init(HeaderStyle.TITLE_LIFT_IMAGEBUTTON);
		mHeaderLayout.setTitleAndLeftImageButton(titleName, leftDrawableId, listener);
	}
