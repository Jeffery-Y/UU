...
import com.example.lenovo.uu.ui.fragment.ContactFragment;
import com.example.lenovo.uu.ui.fragment.RecentFragment;
...
public class MainActivity extends ActivityBase implements EventListener{
	...
	TextView iv_recent_tips,iv_contact_tips;//消息提示
	@Override
	...
	private void initView(){
		...
		iv_recent_tips = (TextView)findViewById(R.id.iv_recent_tips);
		iv_contact_tips = (TextView)findViewById(R.id.iv_contact_tips);
		//把第一个tab设为选中状态
	...
	private void unreadDot(){
		//小圆点提示
		BmobDB.create(this).getAllUnReadCount();
		if(BmobDB.create(this).hasUnReadMsg()){
			iv_recent_tips.setText(Integer.toString(BmobDB.create(this).getAllUnReadCount()));
